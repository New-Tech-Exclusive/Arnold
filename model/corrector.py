"""Corrector — Error Correction and Forward Model.
...
This estimated signal pre-adjusts generation temperature and transformer
...
class Corrector:
    ...
    def update(self, actual_reinforcement: float) -> None:
        ...
        # Update is applied in model.py after reinforcement is known
