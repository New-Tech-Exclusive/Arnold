"""Tier 4 — The Memory (Experience Buffer).
...
Records are tagged with surprise, mood, and reinforcement, then prioritised
for consolidation.
"""
...
class Memory:
    ...
    def __init__(self, genome: Genome) -> None:
        self._genome = genome
        self._capacity = genome.topology.memory_capacity
